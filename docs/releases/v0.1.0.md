# devfolio v0.1.0 Release Notes

**Release Date:** 2026-02-28

## Overview

Initial release of **devfolio**, a CLI tool for generating developer
portfolios and team velocity metrics from GitHub activity. A key feature
is AI collaboration tracking to measure how "AI-native" developers are by
detecting AI coding assistant co-authors in commit messages.
...
- [Documentation](https://plexusone.github.io/devfolio)
